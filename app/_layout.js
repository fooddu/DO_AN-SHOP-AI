...
/**
 * HomeScreen: hiển thị logo, danh mục, và lưới sản phẩm 2 cột.
 * - Nếu API thất bại hoặc trả rỗng, dùng `sampleProducts` để render tạm.
 * - Đổi API_URL thành IP của máy bạn (ipconfig -> IPv4).
 */
export default function HomeScreen({ navigation }) {
  ...
  // Dữ liệu mẫu (nếu backend chưa có hoặc lỗi)
